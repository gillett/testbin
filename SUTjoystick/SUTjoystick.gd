...
#   get_angle(name, player) -  pass the input name (leftstick, rightstick, or dpad) you wish to poll and player number (optional). Returns angle in degrees, or null if no angle.
